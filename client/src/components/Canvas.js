            ...
            <Col lg={5} xl={5} md={5} sm={5} className="justify-content-center ">
                ...
                <Row>
                    <Col xl={12} lg={12} sm={12} md={12} className="justify-content-center d-flex">
                        <img src={right} onClick={props.decrement} className="align-self-center" style={{cursor:"pointer"}} width="13%" height="20%" />
                        <img src={coche}  width="60%" height="60%" className="align-self-center"></img>
                        <img src={next} onClick={props.increment} className="align-self-center" style={{cursor:"pointer"}} width="13%" height="20%" />
                    </Col>
                </Row>
